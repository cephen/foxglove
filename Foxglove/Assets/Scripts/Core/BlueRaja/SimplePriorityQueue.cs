...
namespace BlueRaja {
    ...
    public class SimplePriorityQueue<TItem, TPriority> : IPriorityQueue<TItem, TPriority>
        ...
        public bool Contains(TItem item) {
            lock (_queue) { return item == null ? _nullNodesCache.Count > 0 : _itemToNodesCache.ContainsKey(item); }
        }
        ...
        public void Enqueue(TItem item, TPriority priority) {
            lock (_queue) {
                ...
                if (item == null) { nodes = _nullNodesCache; }
        ...
        /// <summary>
        /// Enqueue a node to the priority queue if it doesn't already exist.  Lower values are placed in front. Ties are broken by
        /// first-in-first-out.
        ...
        public bool EnqueueWithoutDuplicates(TItem item, TPriority priority) {
            lock (_queue) {
                ...
                else if (_itemToNodesCache.ContainsKey(item)) { return false; }
                else {
                    nodes = new List<SimpleNode>();
                    _itemToNodesCache[item] = nodes;
                }
...
#region Constructors
        ...
        /// .default
        /// </param>
        public SimplePriorityQueue(IComparer<TPriority> priorityComparer) : this(
            priorityComparer.Compare,
        ...
        public SimplePriorityQueue(Comparison<TPriority> priorityComparer) : this(
            priorityComparer,
            EqualityComparer<TItem>.Default
        ) { }
        ...
        public SimplePriorityQueue(IEqualityComparer<TItem> itemEquality) : this(
